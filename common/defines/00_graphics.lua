...
NGraphics = {
    ...
    GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_A = 250, --250.0
    GRADIENT_BORDERS_THICKNESS_SUPPLY_AREA_B = 250, --250.0
    ...
    STRATEGIC_AIR_COLOR_BAD = {0.65, 0, 0, 1},
    STRATEGIC_AIR_COLOR_GOOD = {0, 0.65, 0, 1},
    STRATEGIC_AIR_COLOR_AVERAGE = {0.65, 0.65, 0, 1},
	...
	RESISTANCE_COLOR_NONE = {0.0, 0.0, 0.0, 1}, -- rgba
	RESISTANCE_COLOR_GOOD = {0.0, 0.65, 0, 1},
    RESISTANCE_COLOR_AVERAGE = {0.65, 0.65, 0, 1},
    RESISTANCE_COLOR_BAD = {0.65, 0, 0, 1},
	CONSTRUCTION_CONVERSION_COLOR = { 0.9, 0.9, 0.3, 1},
	CONSTRUCTION_CONVERSION_IN_PROGRESS_COLOR = { 0.3, 0.3, 0.9, 0.1},
	STRATEGIC_NAVY_COLOR_MISSION = {0.65, 0.65, 0.0, 1},
    STRATEGIC_NAVY_COLOR_NEUTRAL = {130.0/255, 130.0/255, 130.0/255, 1},
	...
	COUNTRY_FLAG_STRIPE_TEX_MAX_HEIGHT = 4102,
	...
	COUNTRY_COLOR_BRIGHTNESS_MODIFIER = 0.7,
