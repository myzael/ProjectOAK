...
NDiplomacy = {
	...
	VOLUNTEERS_PER_TARGET_PROVINCE = 0.04,			-- Each province owned by the target country contributes this amount of volunteers to the limit.
...
NNavy = {
	...
	COMBAT_MIN_WIN_CHANCE_TO_KEEP_FIGHTING = 0.2,		 			-- DNM - original 0.2 - being at 60 per cent of the enemy's strength would usually lead to one side disengaging, and seems to work reasonably in tests -- compare our forces with enemy forces. 1.0 is equal win chances. Less then 1.0 is we have low chances. If we have at least X chances, then ships will attept to attack without waiting for the other ships that are on the way.
