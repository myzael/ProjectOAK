...
NMilitary = {
	...
	LAND_SPEED_MODIFIER = 0.025,                    -- basic speed control
	...
	ENEMY_AIR_SUPERIORITY_DEFENSE_STEEPNESS = 90, -- how quickly defense approaches the max impact diminishing returns curve
...
NAir = {
	...
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.30,					-- Anti Air Gun hit chance
