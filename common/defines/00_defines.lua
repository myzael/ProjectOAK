...
NMilitary = {
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 0.0003,
	UNIT_EXPERIENCE_SCALE = 1.0,
	UNIT_EXPERIENCE_PER_TRAINING_DAY = 0.002,
...
NNavy = {
	...
	COMBAT_RETREAT_DECISION_CHANCE = 0.20, 							-- There is also random factor in deciding if we should retreat or not. That causes a delay in taking decision, that sooner or later will be picked. It's needed so damaged fast ships won't troll the combat.
	...
	COMBAT_ARMOR_PIERCING_DAMAGE_REDUCTION = -0.8,					-- DNM, to be consistent with changes to vanilla, makes armour more important, as it shold be -- All damage reduction % when target armor is >= then shooter armor piercing.
	...
	SUBMARINE_HIDE_TIMEOUT = 13,	-- Amount of in-game-hours that takes the submarine (with position unrevealed), to hide.
	...
	SUPPLY_NEED_FACTOR = 6,										    -- multiplies supply usage
	SEA_AIR_COMBAT_MAX_WINGS_ON_STACK =  300,                       -- DNM original 200 -- how many attacker planes can enter naval comabt per wave
